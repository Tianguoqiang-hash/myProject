  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="item in address" :key="item.id">
        ...
        <p @click="changeOpt(item,address)">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(item,index) in orderList.detailArrayList" :key="index">
          <li>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{selectOpt.fullAddress}}</span>
        收货人：<span>{{selectOpt.consignee}}</span>
        <span>{{selectOpt.phoneNum}}</span>
      </div>
    </div>
...
<script>
 import {mapState} from 'vuex'
  export default {
    ...
    computed:{
      ...mapState({address:(state)=>state.trade.address}),
      ...mapState({orderList:(state)=>state.trade.shopCartList}),
      selectOpt(){
